...
### Request description: 
```
    "do_explicit_simulation": if true, then the RPC server simulate insertion of the block to the core and if it's failed the transactions that failed it would be blacklisted
