...
- Unlike the seed phrase, which is generated by the wallet, the passphrase is chosen by you. It follows the same character and length rules as other Zano passwords (see the [Password Specification](/docs/learn/password-specs)).
