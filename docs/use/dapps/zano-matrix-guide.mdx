...
1. Like all Zano dApps, Zano Matrix requires using Zano Companion; [click here](/docs/use/companion) if you haven't set it up already.
...
##### **What happens if the Zano Matrix server goes down?**
