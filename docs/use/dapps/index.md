...
Zano's dApps run in your browser and act on your own wallet: trading, messaging, and bridging all settle through transactions you sign yourself.

:::info Start with Zano Companion
...
- **[Wrapped Zano](/docs/use/wrapped-zano)**: WZANO, an ERC-20 token on Ethereum, exchangeable 1:1 for native ZANO.

Each guide walks through setup, everyday use, and the questions users hit most often.
